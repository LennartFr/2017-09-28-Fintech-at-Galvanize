...
6:20: Tom Eck: Introduction to the IBM fintech space: The finance services on Bluemix: 
       the IBM experimental services and the Business Partner services, and use cases.   
